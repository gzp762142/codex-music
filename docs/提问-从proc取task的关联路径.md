...
task+0x30 = 0xffffffe130da45170 -> 0xfffffe130da45170 [kernel domain]
task+0x38 = 0xffffffe130bdfc4e0 -> 0xfffffe130bdfc4e0 [kernel domain]
task+0x40 = 0 -> 0 [small int]
task+0x48 = 0 -> 0 [small int]
task+0x50 = 0 -> 0 [small int]
task+0x58 = 0xffffffe130a7dc34d -> 0xfffffe130a7dc340 [kernel domain]
task+0x60 = 0xffffffe130a5c2bc0 -> 0xfffffe130a5c2bc0 [kernel domain]
task+0x68 = 0xffffffe13efa05300 -> 0xfffffe13efa05300 [kernel domain]
task+0x70 = 0xffffffe001a1241a0 -> 0xfffffe001a1241a0 [kernel domain]
...
（说明：raw 列里有些值的高位看起来"像被截断或错位"，那是本例的 PAC 还原步骤对某些槽
做了一次 `| PAC_MASK` —— 只有 6 个槽的值因此改变。这一条本身不是本次要问的重点，
但如果你认为它影响判读，请一并指出。）
